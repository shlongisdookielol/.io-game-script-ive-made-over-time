...
(() => {
    ...
    WebSocket.prototype.send = function (emologanpaul) {
        if (main) {
            GM_setValue("WSVal", Array.from(new Uint8Array(emologanpaul)));
        }
        ws = this;
        return websockets.call(this, emologanpaul);
    };

    GM_addValueChangeListener("WSVal", (prostate) => {
